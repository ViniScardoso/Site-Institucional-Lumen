...
function cadastrar(req, res) {
    ...
    var logon = req.body.logonServer;
    var senha = req.body.senhaServer;
    var cpf = req.body.cpfServer;
    var fone = req.body.foneServer;
    ...
    // Faça as validações dos valores
     if (logon == undefined) {
        ...
        usuarioModel.cadastrarShopping(nomeEmp, endereco, cnpj )
        .then(
            function (resultado) {
                res.json(resultado);
            }
        ...
        usuarioModel.cadastrar(nome, logon, senha, cpf, fone, cnpj)
            .then(
                function (resultado) {
                    res.json(resultado);
                }
